...
public class ParentScript : MonoBehaviour
{
...

    {
        ...
        FindObjectOfType<ChildScript>().WriteMessage(ChildScript.StaticMessage);
        FindObjectOfType<ChildScript>().UpdateStats(ChildScript.StaticCalories, ChildScript.StaticKarmas);
    }
